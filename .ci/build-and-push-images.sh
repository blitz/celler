...
if [[ "$#" -lt "2" ]]; then
	...
	>&2 echo "Example: $0 ghcr.io/blitz/celler main abcd123"
	exit 1
fi
...
manifest_spec="$(mktemp -t celler-manifest-spec.XXXXXXXXXX)"
...
nix build .#celler-server-image .#celler-server-image-aarch64 -L --print-out-paths | \
