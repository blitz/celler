...
impl NixStore {
    ...
    pub fn nar_from_path(
        ...
        // We create a new store connection, because the implementation of
        // daemon.nar_from_path is fragile. We also don't want to stream
        // multiple NARs at the same time.
